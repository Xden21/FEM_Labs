...
EndIf
Physical Surface("rotor slots N", ROTOR_SLOTS_N) = surfRotorBars[{pppp[]}];
Physical Surface("rotor slots P", ROTOR_SLOTS_P) = surfRotorBars[{nnnn[]}];
Color Orchid  {Surface{surfRotorBars[{nnnn[]}]};}
Color Purple  {Surface{surfRotorBars[{pppp[]}]};}
